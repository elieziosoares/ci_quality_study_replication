...
RUN wget --load-cookies /tmp/cookies.txt "https://docs.google.com/uc?export=download&confirm=$(wget --quiet --save-cookies /tmp/cookies.txt --keep-session-cookies --no-check-certificate 'https://docs.google.com/uc?export=download&id=1wYBZ3ytDi3SB6cBJ8uZ5I7uxBfp3PVcd' -O- | sed -rn 's/.*confirm=([0-9A-Za-z_]+).*/\1\n/p')&id=19XlRFEZtWbnEJsB-aMZ1V4HkW7zrqGzJ" -O backup.sql && rm -rf /tmp/cookies.txt
